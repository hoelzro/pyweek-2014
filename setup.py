...
PACKAGEDATA = {
    ...
    'package_dir': {'threadless': 'threadless',
                   },
    'packages': ['threadless',
                ],
    'scripts': ['scripts/threadless'],
}
...
_DATA_DIR = os.path.join('threadless', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'threadless': data_dirs}
...
src = []
add_files(src,os.walk('threadless'))
